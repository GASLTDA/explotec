...
class TemplateSettings(models.Model):
    ...
    def _default_so_template(self):
        def_tpl = self.env['ir.ui.view'].search(
            [
                ('key',
                 'like',
                 'professional_templates.SO\_%\_document'),
                ('type',
                 '=',
                 'qweb')],
            order='key asc',
    ...
    def _default_po_template(self):
        def_tpl = self.env['ir.ui.view'].search(
            [
                ('key',
                 'like',
                 'professional_templates.PO\_%\_document'),
                ('type',
                 '=',
                 'qweb')],
            order='key asc',
    ...
    def _default_rfq_template(self):
        def_tpl = self.env['ir.ui.view'].search(
            [
                ('key',
                 'like',
                 'professional_templates.RFQ\_%\_document'),
                ('type',
                 '=',
                 'qweb')],
            order='key asc',
    ...
    def _default_dn_template(self):
        def_tpl = self.env['ir.ui.view'].search(
            [
                ('key',
                 'like',
                 'professional_templates.DN\_%\_document'),
                ('type',
                 '=',
                 'qweb')],
            order='key asc',
    ...
    def _default_pk_template(self):
        def_tpl = self.env['ir.ui.view'].search(
            [
                ('key',
                 'like',
                 'professional_templates.PICK\_%\_document'),
                ('type',
                 '=',
                 'qweb')],
            order='key asc',
    ...
    def _default_inv_template(self):
        def_tpl = self.env['ir.ui.view'].search(
            [
                ('key',
                 'like',
                 'professional_templates.INVOICE\_%\_document'),
                ('type',
                 '=',
                 'qweb')],
            order='key asc',
    ...
    watermark = fields.Text(
        'Watermark Python Expression', default='''
